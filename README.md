...
Several natural extensions could make the framework more realistic:

- allow aggressive market orders to move the stock mid-price directly,
- replace constant-volatility GBM with stochastic volatility dynamics such as SABR,
- recalibrate fill intensities and transaction costs for larger order sizes,
- incorporate permanent market impact,
- extend the framework to multi-option or multi-asset books,
- estimate model parameters from real limit order book data.
...
This project is for academic and research purposes only. It is not intended as trading advice or a production trading system.
